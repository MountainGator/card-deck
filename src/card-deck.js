...
const CardDeck = () => {
    ...
    return (
        <div id="container">
            {allow && <button className="draw-card reg" onClick={handleSubmit}>Draw Card</button>}
            {deckIDRef.current && <button className="draw-card red" onClick={handleShuffle}>Shuffle Deck</button>}
